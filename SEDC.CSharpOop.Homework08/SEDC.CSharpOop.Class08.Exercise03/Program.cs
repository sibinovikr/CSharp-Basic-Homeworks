...
namespace SEDC.CSharpOop.Class08.Exercise03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"{GetFullName(Maria)} favourite songs are (length longer than 6 mins): ");
            ...
            Console.WriteLine($"{GetFullName(Jane)} favourite Rock songs are: ");
            ...
            Console.WriteLine($"{GetFullName(Stefan)} favourite Hip-Hop songs are (shorter than 3 mins ): ");
